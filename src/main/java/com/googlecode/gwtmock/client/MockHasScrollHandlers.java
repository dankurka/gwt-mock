 ...
 * 
 */
public class MockHasScrollHandlers extends MockHasHandlers implements HasScrollHandlers {
   ...
   * (non-Javadoc)
   * 
   * @see com.google.gwt.event.dom.client.HasScrollHandlers#addScrollHandler(com
